 ...
 * to execute an {@link ElectCouncillor} action controlling
 * its validation.<br>
 * The difference with the {@link UseAssistantToElectCouncillor} is that this
 * action give to {@link Player} four coins.<br>
 ...
 *
 */
public class ElectCouncillorRqst extends MainActionRqst {
	 ...
	 */
	public ElectCouncillorRqst(Token token, Region targetRegion, Colore colore) {
		super(token);
