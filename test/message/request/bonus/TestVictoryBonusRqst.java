...
public class TestVictoryBonusRqst {

	VictoryBonusRqst request;
	private Game game;
	...
	public void testConsturctorWithTokenNullValuesShouldThrowANullPointerException() {
		...
		request = new VictoryBonusRqst(null, new QuantityBonus("VICTORYBONUS", 3));
	}
	
	@Test(expected = NullPointerException.class)
	public void testConsturctorWithBonusNullValuesShouldThrowANullPointerException() {
		
		request = new VictoryBonusRqst(new Token(), null);
	}
	...
	public void initializeRequest() {
		...
		request = new VictoryBonusRqst(new Token(), new QuantityBonus("VICTORYBONUS", 2));
	}
	...
	public void testAcceptWhenTheBonusIsASingleBonusShouldThrowAnIllegalActionException() throws IllegalActionException {
		...
		request = new VictoryBonusRqst(new Token(), new SingleBonus("VICTORYBONUS"));
	...
	@Test
	public void testAcceptShouldReturnAVictoryBonusActionNotNull() throws IllegalActionException {
	...
	@Test(expected = IllegalActionException.class)
	public void testAcceptWhenTheBonusNameIsNotVictoryBonusShouldThrowAnIllegalActionException() throws IllegalActionException {
		
		request = new VictoryBonusRqst(new Token(), new QuantityBonus("COINSBONUS", 2));
		request.accept(game, player, visitor);
	}
